...
let tempPeoplesGrown = 2,
  tempPeoplesChild = 0,
  tempPeoplesBaby = 0,
  tempPeoplesNum = 2,
  score = decodeURIComponent(location.search.substr(1)).split("search="),
  peoplesBaby = null,
  peoplesChild = null,
  peoplesGrown = null,
  cities = [];
...
if (score.length > 1) {
  score.splice(0, 1);
  let e = score[0];
  (peoplesBaby = String(e).substr(-1, 1)),
    (peoplesChild = String(e).substr(-2, 1)),
    (peoplesGrown = String(e).substr(-3, 1)),
    ...
    cities.push(city2),
    (day1 = e.substr(3, 2)),
    (month1 = parseInt(e.substr(5, 2)) - 1),
    (year1 = e.substr(7, 2)),
  e.length > 12 &&
  ((day2 = e.substr(12, 2)),
    (month2 = parseInt(e.substr(14, 2)) - 1),
    (year2 = e.substr(16, 2)));
}
...
if(searchInputs.length) {
  searchInputs.forEach(async (e, t) => {
    if (
      (t < 1
        ? e.addEventListener("input", () => {
          let e = document.querySelectorAll(".tip")[0],
            t = document.querySelectorAll(".tip")[1];
          e.classList.remove("_active"), t.classList.remove("_active");
        })
        : e.addEventListener("input", () => {
          let e = document.querySelectorAll(".tip")[2],
            t = document.querySelectorAll(".tip")[3];
          e.classList.remove("_active"), t.classList.remove("_active");
        }),
        cities.length)
    ) {
      let i = await fetch(
          `http://autocomplete.travelpayouts.com/places2?term=${cities[t]}&locale=ru&types[]=city`
        ),
        s = await i.json();
      (e.value = String(await s[0].name)),
        (e.dataset.value = `${s[0].name}, ${s[0].country_name}\n${s[0].code}`);
    }

    e.classList.add("autocomplete-input");
    let i = document.createElement("div");
    (i.className = "autocomplete-wrap"),
      e.parentNode.insertBefore(i, e),
      i.appendChild(e);
    let s = document.createElement("div");
    (s.className = "autocomplete-list"), i.appendChild(s);
    let a = document.createElement("div");
    (a.className = "antother-city tip"),
      (a.innerHTML = "Укажите разные города"),
      i.appendChild(a),
      (a = document.createElement("div")),
      (a.className = "empty-city tip"),
      (a.innerHTML = "Укажите город прибытия"),
      i.appendChild(a);
    let r = [],
      n = [],
      o = -1;
    ...
    function h(t) {
      if (!n[t]) return !1;
      (e.dataset.value = n[t].innerText),
        (e.value = n[t].innerText.split(",")[0]),
        l(!1);
    }
    ...
    e.addEventListener("input", async (t) => {
      if ((t = e.value.trim()).length > 0) {
        let i = [];
        const a = await fetch(
          `http://autocomplete.travelpayouts.com/places2?term=${t}&locale=ru&types[]=city`
        );
        (await a.json()).forEach((e) => {
          i.push(
            `<div class="item-names"><strong>${e.name},</strong> ${e.country_name}</div> <span class="text-primary">${e.code}</span>`
          );
        });
        let o = e.value;
        if (!o) return l(!1);
      ...
      e.addEventListener("keydown", (e) => {
        let t = e.keyCode;
        40 === t
          ? (e.preventDefault(), o++, d(o))
          : 38 === t
            ? (e.preventDefault(), o > 0 && o--, d(o))
            : 27 === t
              ? l(!1)
              : 13 === t && h(o);
      }),
  ...
  let menuSelectNum = document.querySelector(".menu__select-num"),
    babyFull = !1;
  const menuSelect = document.querySelector(".menu__select"),
    peoplesFilter = document.querySelector(".peoples-filter"),
    ...
    babyMinus = document.querySelector(".peoples-filter__baby-minus"),
    minuses = document.querySelectorAll("._minus"),
    grownPlus = document.querySelector(".peoples-filter__grown-plus"),
    childPlus = document.querySelector(".peoples-filter__child-plus"),
    babyPlus = document.querySelector(".peoples-filter__baby-plus"),
    pluses = document.querySelectorAll("._plus"),
  ...
  function updateForms(e = null, t = null, i = null) {
    const s = +e || +grownNum.innerHTML,
      a = +t || +babyNum.innerHTML,
      r = +i || +childNum.innerHTML;
    (grownNum.innerHTML = s),
      (childNum.innerHTML = r),
      (babyNum.innerHTML = a),
      1 == s || s == a
        ? grownMinus.classList.remove("_active")
        : grownMinus.classList.add("_active"),
      0 == r
        ? childMinus.classList.remove("_active")
        : childMinus.classList.add("_active"),
      0 == a
        ? babyMinus.classList.remove("_active")
        : babyMinus.classList.add("_active"),
      s + a + r > 8
        ? (grownPlus.classList.remove("_active"),
          childPlus.classList.remove("_active"),
          babyPlus.classList.remove("_active"),
          (babyFull = !1))
        : (grownPlus.classList.add("_active"),
          childPlus.classList.add("_active"),
          a == s
            ? (babyPlus.classList.remove("_active"), (babyFull = !0))
            : (babyPlus.classList.add("_active"), (babyFull = !1)));
    let n = s + a + r;
    menuSelectNum.innerHTML =
      n < 2
        ? n + " пассажир"
        : n > 1 && n < 5
          ? n + " пассажира"
  ...
  updateForms(peoplesGrown, peoplesBaby, peoplesChild), //! Обработчики событий
  ...
  menuSelect.addEventListener("focus", () => {
    peoplesFilter.classList.add("_active"),
      menuSelect.classList.add("_active");
  }),
    document.addEventListener("click", (e) => {
      const t = e.target;
      menuSelect.contains(t) ||
      (peoplesFilter.classList.remove("_active"),
    ...
    pluses.forEach((e) => {
      e.addEventListener("click", () => {
        ...
        ((e.previousElementSibling.innerHTML =
          +e.previousElementSibling.innerHTML + 1),
          updateForms());
      });
    }),
  ...
  const selected_date_element = document.querySelector("._calendar"),
    selected_date_element2 = document.querySelector("._calendar2"),
    dates_element = document.querySelector(" .dates"),
    dates_element2 = document.querySelector(" .dates2"),
    mth_element = document.querySelector(" .dates .month .mth"),
    mth_element2 = document.querySelector(" .dates2 .month .mth"),
    next_mth_element = document.querySelector(".next-mth"),
    prev_mth_element = document.querySelector(".prev-mth");
  let days_element = document.querySelector(" .dates .days"),
    days_element2 = document.querySelector(" .dates2 .days"),
    calendars = document.querySelector(".calendars"),
    calendars_down = document.querySelector(".calendars__down"),
    calendars_top = document.querySelector(".calendars__top"),
    arrow1 = document.querySelector(".prev-mth"),
    arrow2 = document.querySelector(".next-mth"),
    back_btn = document.querySelector(".calendars__back-btn"),
  ...
  let day = date.getDate(),
    ...
    selectedDate = day1 ? new Date(+year1 + 2e3, month1, day1) : date,
    selectedDay = day1 || day,
    selectedMonth = month1 || month,
    selectedYear = year1 || year,
    selectedDate2 = day2 ? new Date(+year2 + 2e3, month2, day2) : null,
    selectedDay2 = day2 || null,
    selectedMonth2 = month2 || null,
    selectedYear2 = year2 || null,
    isFirstClick = !0,
    isFirstInput = !0;
  ...
  function toggleDatePicker(e) {
    ...
    checkEventPathForClass(e.path, "dates2") ||
    (calendars.classList.add("active"),
      (isFirstClick = !0),
      (isFirstInput = !0));
  }
  ...
  function removeDatePicker(e) {
    checkEventPathForClass(e.path, "dates") ||
    checkEventPathForClass(e.path, "dates2") ||
    (calendars.classList.remove("active"),
      (isFirstClick = !0),
      (isFirstInput = !0),
  ...
  function goToNextMonth(e = !0) {
    let t = month + 2,
      i = year;
    if ((t > 11 && ((t = 0 - (12 - t)), i++), new Date(i - 1, t, day) > date))
      return !1;
    (month = t),
      (year = i),
    e &&
    ((mth_element.textContent = months[month] + " " + year),
      NextMonth(),
      (mth_element2.textContent = months[month] + " " + year),
      PrevMonth(),
      populateDates());
  }
    ...
    for (let e = 0; e < 2; e++) {
      ...
      for (let i = 0; i < t; i++) {
        if (grayedDay(i + 1)) {
          const e = document.createElement("div");
          (e.textContent = i + 1),
            e.classList.add("grayed-day"),
            days_element.appendChild(e);
          continue;
        }
        ...
        selectedDate2 >= s && s >= selectedDate && t.classList.add("selecteds"),
        selectedDay == i + 1 &&
        selectedYear == year &&
        selectedMonth == month &&
            ...
            ? t.addEventListener("click", function (e) {
              isFirstClick
                ...
                ((selectedDate2 = [
                  ...
                  (selected_date_element.value = formatDate(selectedDate)),
                  (selected_date_element2.value = formatDate(selectedDate2)),
                  paintDays(),
                isFirstInput && (isFirstClick = !0),
                  calendars.classList.remove("active")),
                populateDates();
            })
            : t.addEventListener("click", function (e) {
  ...
  function grayedDay(e) {
    let t = new Date(year, month, e),
      i = new Date(date.getFullYear() + 1, date.getMonth(), date.getDate());
    return t < date || t > i;
  }
  ...
  function checkEventPathForClass(e, t) {
    for (let i = 0; i < e.length; i++)
      if (e[i].classList && e[i].classList.contains(t)) return !0;
  ...
  mth_element.textContent = months[month] + " " + year, NextMonth(), mth_element2.textContent = months[month] + " " + year, PrevMonth(), selected_date_element.value = formatDate(selectedDate), selected_date_element.dataset.value = formatDate(selectedDate), isNaN(Date.parse(selectedDate2)) || (selected_date_element2.value = formatDate(selectedDate2), selected_date_element2.dataset.value = formatDate(selectedDate2)), populateDates(), selected_date_element.addEventListener("click", toggleDatePicker), selected_date_element2.addEventListener("click", clickSecondInput), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || (selected_date_element.addEventListener("focus", toggleDatePicker), selected_date_element2.addEventListener("focus", clickSecondInput)), next_mth_element.addEventListener("click", goToNextMonth), prev_mth_element.addEventListener("click", goToPrevMonth), back_btn.addEventListener("click", (function (e) {
              ...
              if ("auto" === e.slidesPerView) {
                ...
                if (H && (D[0].style.transform = "none"), F && (D[0].style.webkitTransform = "none"), e.roundLengths) C = this.isHorizontal() ? D.outerWidth(!0) : D.outerHeight(!0); else if (this.isHorizontal()) {
                  var V = parseFloat(_.getPropertyValue("width")), B = parseFloat(_.getPropertyValue("padding-left")),
                    ...
                    Y = parseFloat(_.getPropertyValue("margin-left")),
    ...
    function _(t, i) {
      ...
      var s = i.indexOf("tap") >= 0, a = i.indexOf("drag") >= 0, r = i.indexOf("fixed") >= 0,
        n = i.indexOf("snap") >= 0,
